...
"darwin-thread-multi-2level-20.0" or
	die "Errno architecture (darwin-thread-multi-2level-20.0) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
